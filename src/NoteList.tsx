...
export function NoteList({availableTags, notes, onUpdateTag, onDeleteTag}: NoteListProps) {
    ...
    const [editTagsModalisOpen, setEditTagsMovalIsOpen] = useState(false)
        ...
        <Col><h1>Notes</h1></Col>
            <Col xs="auto">
                <Stack gap={2} direction="horizontal">
                    ...
                    <Button onClick={() => setEditTagsMovalIsOpen(true)} variant="outline-secondary">Edit Tags</Button>
                </Stack>
        </Col>
    </Row>
    <Form>
    ...
    <EditTagsModal onUpdateTag={onUpdateTag} onDeleteTag={onDeleteTag} show={editTagsModalisOpen} handleClose={() => setEditTagsMovalIsOpen(false)} availableTags={availableTags}/>
    </>
}
